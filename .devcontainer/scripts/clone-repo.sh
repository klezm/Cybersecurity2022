...
if false; then
    # -rw-r--r--   1 vscode vscode 1.5K Feb  3 16:04 cifuzz.yaml
    # -rw-rw-rw-   1 vscode vscode  682 Feb  3 16:04 pom.xml
    # -rw-rw-rw-  1 vscode vscode  24K Feb  3 16:04 pom.xml
    # -rw-r--r--  1 vscode vscode  678 Feb  3 16:04 FuzzRrdp.java

    # -rw-r--r--   1 vscode vscode 1.5K Feb  3 16:04 cifuzz.yaml
    # -rw-rw-rw-   1 vscode vscode 1.2K Feb  3 16:04 pom.xml
    # -rw-rw-rw-  1 vscode vscode 1.5K Feb  3 16:04 cifuzz.yaml
    # -rw-rw-rw-  1 vscode vscode  26K Feb  3 16:04 pom.xml
    # -rw-r--r--  1 vscode vscode  829 Feb  3 16:04 FuzzRrdp.java
    # -rw-rw-rw-  1 vscode vscode 1.7K Feb  3 16:04 FuzzTest.java



    # rpki-validator-3/pom.xml
    # rpki-validator-3/cifuzz.yaml
    # rpki-validator-3/rpki-validator/pom.xml
    # rpki-validator-3/rpki-validator/cifuzz.yaml
    # rpki-validator-3/rpki-validator/src/test/java/net/ripe/rpki/validator3/rrdp/FuzzRrdp.java
    # rpki-validator-3/rpki-validator/src/test/java/net/ripe/rpki/validator3/rrdp/FuzzTest.java
